...
export default function TasksPage() {
    ...
    const taskStats = {
        ...
        telegram: {title: "Telegram", verifyTitle: "Subscribe"},
    ...
    return (
        <div className={"h-full w-full  flex flex-col items-center gap-12   text-white font-medium"}>
            ...
            <div className={"flex items-center gap-2"}>
                ...
                <span className={"z-10 text-4xl font-bold text-zinc-200"}>1000</span>
            </div>
            ...
            <div className={" w-full"}>
                ...
                <div className={"flex  flex-col gap-4"}>
                    <div className={"flex flex-col gap-5"}>
                        <div className={"flex justify-between items-center"}>
                            ...
                            <span className={"font-semibold z-10"}>(6)</span>
                        </div>
                        <hr className={"z-10"}/>
                    </div>
                ...
                <Sheet detent={"content-height"} isOpen={isOpen} onClose={() => setOpen(false)}>
                    <Sheet.Container style={{background: "#000000f9", color: "#fff"}}>
                        <Sheet.Header/>
                        <Sheet.Content>
                            <div className={"flex py-4 w-full h-[450px] justify-between items-center flex-col gap-6"}>
